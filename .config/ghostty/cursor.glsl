...
const vec4 CURRENT_CURSOR_COLOR = vec4(0.0, 0.6, 0.8, 1.0); // blue-green
const vec4 PREVIOUS_CURSOR_COLOR = CURRENT_CURSOR_COLOR;
const vec4 TRAIL_COLOR = vec4(0.0, 0.75, 0.65, 0.45);
const vec4 TRAIL_COLOR_ACCENT = vec4(0.0, 0.9, 0.75, 0.9);
